...
export const QUESTION_KINDS: QuestionKind[] = [
  ...
  // ── Identity ──
  { key: 'artist_name', label: 'Artist / band name', category: 'identity', lengthSensitive: false, reuse: 'verbatim', match: /(artist|band|act|performer|project|stage|group)('s)? name|^(artist|band|act)$|name of (the )?(artist|band|act)/i },
  ...
  { key: 'streaming_stats', label: 'Streaming & audience numbers', category: 'logistics', lengthSensitive: false, reuse: 'verbatim', match: /monthly listeners|streams|followers|audience size|draw|how many (fans|followers)|social (reach|following)/i },
  { key: 'how_did_you_hear', label: 'How you heard about it', category: 'logistics', lengthSensitive: false, reuse: 'verbatim', match: /how did you (hear|find|learn)|referral|referred by|where did you hear/i },
]
