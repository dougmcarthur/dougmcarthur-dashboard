    ...
    <div className="bg-surface border border-line rounded-xl shadow-card overflow-hidden animate-pulse">
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="px-4 py-3 border-b border-line flex gap-6 items-center last:border-0">
          <div className="h-4 bg-sunken rounded w-40" />
          <div className="h-3 bg-sunken rounded w-20" />
          <div className="h-3 bg-sunken rounded w-24" />
          <div className="h-3 bg-sunken rounded w-16" />
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div key={i} className="px-4 py-3 flex items-center justify-between">
          <div className="space-y-1.5">
            <div className="h-4 bg-sunken rounded w-48" />
            <div className="h-3 bg-sunken rounded w-32" />
          </div>
          <div className="h-5 bg-sunken rounded-full w-20" />
        </div>
      ))}
